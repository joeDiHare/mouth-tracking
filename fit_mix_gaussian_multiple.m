function [u,sig,t,iter] = fit_mix_gaussian_multiple( X,M )
%%% fit_mix.. fits multiple (M) gaussians in the mixtures by using EM algorithm. 
%%% This function was given by Mathias Dietz and used in his model to classify different DOAs (2011)
...
if ~nargin
    ...
    u   = randn(1,M)*8;
    prob= rand(1,M);
    [u,sig,t,iter] = fit_mix_gaussian_ad2( build_mix_gaussian( u,sig,prob,2000*M ),M );
    return
end
